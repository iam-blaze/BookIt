																		...
																		<li class="span1_of_1 desti">
																			 ...
																			 <div class="book_date">
																					...
																					<div class="section_room">
                                                                                                                                                         ...
                                                                                                                                                         <h5 style="padding-top: 25px">Username</h5>
                                                                                                                                                         <div class="book_date" >																				
																					<div class="section_room">
                                                                                                                                                                            <input type="text" name="username" required="required" placeholder="Id" autocomplete="off">
                                                                                                                                                                    </div>																				
																			 </div>
																		 </li>                                                                                                                                                
																	...
																	<ul>	
																		 <li class="span1_of_3">
																				<div class="date_btn">
                                                                                                                                                                    ...
                                                                                                                                                                    <input type="submit" id="Search" name="book" value="Search">
